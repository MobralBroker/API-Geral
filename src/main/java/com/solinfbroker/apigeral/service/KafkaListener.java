...
public class KafkaListener {
    ...
    public void listeningAtualizacaoMercado(ConsumerRecord<String, String> mensagem)  {
        log.info("CONSUMER message from Kafka: {}", mensagem.value());
    ...
    public void listeningInfoUsuario(ConsumerRecord<String, String> mensagem)  {
        log.info("CONSUMER message from Kafka: {}", mensagem.value());
    ...
    public void listeningSaudeCheck(ConsumerRecord<String, String> mensagem)  { //Adicionar o Objeto que desejo receber, no lugar da segunda string, este objeto será um DTO novo com a adição do campo __op
        log.info("CONSUMER message from Kafka: {}", mensagem.value());
    ...
    public void listeningAtualizacaoTeste(ConsumerRecord<String, String> mensagem)  {
        log.info("CONSUMER message from Kafka: {}", mensagem.value());
    ...
    public void listeningAtualizacaoBanco(ConsumerRecord<String, String> mensagem)  {
        log.info("ClienteController: {}", mensagem.value());
        /* Business rule code with message */
    }
